  ...
  return (
    <div className="bg-white min-h-screen pt-20 font-sans selection:bg-[#10B981] selection:text-white">
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden border-b border-gray-100">
        ...
        <div className="absolute -top-32 -left-32 w-[600px] h-[600px] bg-[#059669] rounded-full blur-[140px] opacity-10 pointer-events-none"></div>
        
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold text-[#0F172A] mb-8 tracking-tight leading-tight">
            Empowering <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#10B981] to-[#059669]">Research.</span> <br />
            Supporting Success.
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <p className="text-sm font-bold text-gray-400 tracking-wider uppercase mb-4 flex items-center gap-2">
              <span className="w-4 h-[2px] bg-[#10B981]"></span> OUR STORY
            </p>
      ...
      <section className="py-24 bg-[#F8FAFC] relative border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="bg-[#0F172A] p-16 rounded-[3rem] relative shadow-2xl">
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#10B981] rounded-full blur-[60px] opacity-30 pointer-events-none"></div>
            <h3 className="text-4xl font-extrabold text-white mb-6 leading-tight">
              Turning Ideas <br /> Into Impact <br /> Together
            </h3>
            <p className="text-gray-400 font-medium leading-relaxed border-l-4 border-[#10B981] pl-6">
          ...
          <div className="space-y-16">
            <div>
              <p className="text-sm font-bold text-gray-400 tracking-wider uppercase mb-3 flex items-center gap-2">
                <span className="w-4 h-[2px] bg-[#10B981]"></span> THE GOAL
              </p>
            ...
            <div>
              <p className="text-sm font-bold text-gray-400 tracking-wider uppercase mb-3 flex items-center gap-2">
                <span className="w-4 h-[2px] bg-[#10B981]"></span> THE OUTLOOK
              </p>
      ...
      <section className="py-24 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <p className="text-sm font-bold text-gray-400 tracking-wider uppercase mb-3 flex items-center gap-2">
              <span className="w-4 h-[2px] bg-[#10B981]"></span> CUSTOMER COMMITMENT
            </p>
            ...
            <ul className="space-y-6">
              <li className="flex gap-4">
                <div className="mt-1"><ShieldCheck className="text-[#10B981]" size={24} /></div>
              ...
              <li className="flex gap-4">
                <div className="mt-1"><Award className="text-[#10B981]" size={24} /></div>
              ...
              <li className="flex gap-4">
                <div className="mt-1"><Zap className="text-[#10B981]" size={24} /></div>
              ...
              <li className="flex gap-4">
                <div className="mt-1"><Lightbulb className="text-[#10B981]" size={24} /></div>
              ...
              <li className="flex gap-4">
                <div className="mt-1"><HeartHandshake className="text-[#10B981]" size={24} /></div>
          ...
          <div className="relative flex justify-center">
             <div className="w-full max-w-md aspect-square bg-[#0F172A] rounded-[3rem] p-12 flex flex-col justify-center shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#10B981] rounded-full blur-[50px] opacity-40"></div>
      ...
      <section className="py-32 bg-[#F8FAFC] text-center border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6">
          <p className="text-sm font-bold text-gray-400 tracking-wider uppercase mb-6 flex items-center justify-center gap-2">
            <span className="w-4 h-[2px] bg-[#10B981]"></span> FINAL NOTE
          </p>
          ...
          <button className="text-lg font-bold text-[#10B981] hover:text-[#059669] transition-colors pb-1 border-b-2 border-[#10B981]">
